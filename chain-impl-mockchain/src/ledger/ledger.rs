...
mod tests {
    ...
    use crate::{
        ...
        testing::{
            ...
            builders::{create_initial_transaction, witness_builder, TransactionBuilder},
    ...
    */
    ...
    pub fn input_utxo_verify_negative_prop_test(
        ...
        let message =
            create_initial_transaction(Output::from_address(faucet.address.clone(), Value(100)));
        let (_, ledger) =
    ...
    pub fn test_internal_apply_transaction_verify_pot() {
        ...
        let mut faucet = AddressDataValue::account(Discrimination::Test, Value(101));
