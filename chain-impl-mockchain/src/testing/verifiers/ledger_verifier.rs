...
pub struct LedgerStateVerifier {
    ...
    impl DistributionVerifier {
        ...
        pub fn dangling_is(&self, dangling: Value) -> &Self {
            assert_eq!(dangling,self.stake_distribution.dangling,"wrong unassigned distribution value");
            self
        }
        ...
        pub fn unassigned_is(&self,unassigned: Value) -> &Self {
            assert_eq!(unassigned,self.stake_distribution.unassigned,"wrong unassigned distribution value");
            self
        }

        pub fn pools_total_stake_is(&self, pools_total: Value) -> &Self {
            assert_eq!(pools_total,self.stake_distribution.total_stake(),"wrong total stake");
            self
        }
    }