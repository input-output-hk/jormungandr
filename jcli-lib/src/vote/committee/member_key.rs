...
pub struct Generate {
    ...
    #[cfg_attr(feature = "structopt", structopt(long, name = "CRS", parse(try_from_str = parse_crs)))]
    crs: chain_vote::CRS,

    /// communication keys of all committee members
    #[cfg_attr(feature = "structopt", structopt(long, short, name = "COMMUNICATION_KEYS",
