...
jormungandr1_checksum = sha256sum(
    os.path.join('./unpack-test', jormungandr_name))
...
if jormungandr1_checksum != jormungandr_checksum:
    print('jormungandr checksum mismarch: before {} != after {}'.format(
        jormungandr_checksum, jormungandr1_checksum))
    exit(1)
if jcli1_checksum != jcli_checksum:
    print('jcli checksum mismarch: before {} != after {}'.format(
