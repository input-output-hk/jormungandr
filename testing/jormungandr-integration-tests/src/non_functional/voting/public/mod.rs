...
use crate::{
    non_functional::voting::config::PublicVotingLoadTestConfig, startup::SingleNodeTestBootstrapper,
};
...
pub fn adversary_public_vote_load_scenario(
    ...
    let transaction_sender =
        FragmentSender::from_settings(&settings, generator, FragmentSenderSetup::no_verify());
