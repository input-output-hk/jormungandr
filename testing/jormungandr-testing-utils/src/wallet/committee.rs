...
use chain_impl_mockchain::{certificate::{DecryptedPrivateTally, DecryptedPrivateTallyError, DecryptedPrivateTallyProposal}, vote::VotePlanStatus};
use chain_vote::{
    committee::{
...
impl PrivateVoteCommitteeDataManager {
    ...
    pub fn decrypt_tally(&self, vote_plan_status: &VotePlanStatus) -> Result<DecryptedPrivateTally, DecryptedPrivateTallyError> {
